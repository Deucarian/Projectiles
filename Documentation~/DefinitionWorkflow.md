# Projectiles: definition workflow
...
3. Use its buttons to exercise fire with c#, fire with component, clear projectiles.
4. Inspect the configured hosts and triggers, then open
   [ProjectilesWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/ProjectilesWorkflow.cs). It is the caller
...
- **Fire with C#**: `ProjectilesWorkflow.Fire()`.
- **Fire with component**: `ProjectilesWorkflow.FireComponent()`.
- **Clear projectiles**: `ProjectilesWorkflow.Clear()`.
